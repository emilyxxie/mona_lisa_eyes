...
export declare function stridesWithElidedDims(strides: number[], ellipsisInsertionIndex: number, numElidedAxes: number): number[];
export declare function startIndicesWithElidedDims(startIndices: number[], ellipsisInsertionIndex: number, numElidedAxes: number): number[];
export declare function stopIndicesWithElidedDims(stopIndices: number[], ellipsisInsertionIndex: number, numElidedAxes: number, inputShape: number[]): number[];
